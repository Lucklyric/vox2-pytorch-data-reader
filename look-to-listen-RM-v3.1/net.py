...
class asNet(nn.Module):
    ...
    def forward(self, x):
        ...
        out = torch.reshape(out, [-1, 301, 8 * 257])    # [bath, 297, 8*257]
...
class fuseNet(nn.Module):
    ...
    def forward(self, fuse_feature):
        ...
        out = torch.reshape(out, [-1, 301, 257, 1, 2])    # [batch , 297, 321 ,2]
...
if __name__ == "__main__":
    ...
    test_audio_input = torch.randn(3, 1, 301, 257).to(device_0)
    ...
    out_s1, out_s2 = avnet(test_audio_input)
