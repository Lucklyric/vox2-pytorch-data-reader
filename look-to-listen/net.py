...
class fuseNet(nn.Module):
    ...
    def __init__(self):
        ...
        self.biLSTMLayer = nn.LSTM(256 * 2 + 8 * 321, hidden_size=400, num_layers=1, bidirectional=True, batch_first=True)
        ...
        self.fcMask1 = nn.Linear(600, 321 * 2)
    ...
    def forward(self, fuse_feature):
        ...
        out_s1 = torch.sigmoid(self.fcMask1(out))
        out_s1 = torch.reshape(out_s1, [-1, 2, 297, 321])    # [batch , 297, 321 ,2]
...
class avNet(nn.Module):
    ...
    def __init__(self):
        ...
        self.modified_vgg.classifier = torch.nn.Sequential(torch.nn.Linear(9216, 1000, bias=True))
        self.asnet = asNet()
        self.vsnet = vsNet()
    ...
    def forward(self, video_1, video_2, audio):
        ...
        # print(out_s1.shape)
        return audio * out_s1, audio * out_s2
